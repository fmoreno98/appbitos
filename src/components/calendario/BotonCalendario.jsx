...
const BotonCalendario = ({ day, isEmpty, isPreviousMonth, isNextMonth, isCompleted, isParcial, isFuture, onClick }) => {
  ...
  if (isFuture) {
    ...
    BotonCalendarioClass += ' partial-day'; // Nueva clase para parcialmente completado
  }else {
